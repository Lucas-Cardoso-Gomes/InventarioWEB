...
-- Adiciona suporte para hierarquia na tabela Rede.
-- Adiciona a coluna ParentId para criar a relação de pai/filho entre os dispositivos.
ALTER TABLE Rede
ADD ParentId INT NULL;

-- Adiciona a restrição de chave estrangeira para garantir a integridade da hierarquia.
ALTER TABLE Rede
ADD CONSTRAINT FK_Rede_Rede_ParentId FOREIGN KEY (ParentId) REFERENCES Rede(Id);
