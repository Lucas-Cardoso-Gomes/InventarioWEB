document.addEventListener('DOMContentLoaded', function () {
    ...
    let visibleColumns = JSON.parse(localStorage.getItem('visibleColaboradorColumns')) || defaultVisibleColumns;
    ...
    function savePreferences() {
        localStorage.setItem('visibleColaboradorColumns', JSON.stringify(visibleColumns));
    }
